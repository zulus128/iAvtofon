...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section
{
    ...
    return [[Common instance] getMarkWsServicesCount];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Configure the cell...
    Mark* mark = [[Common instance]getMarkWsServiceAt:indexPath.row];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    Mark* mrk = [[Common instance]getMarkWsServiceAt:indexPath.row];
    detailViewController.mark = mrk;
    detailViewController.typeView = 2;
    //detailViewController.navigationItem.title = mrk.title;
...
/*        Item* item = [[Common instance] getsAt:0];
  ...
  */      
        ...
        [[Common instance] clearMarkWsServices];
        if(![self addServices:XML_SERVICES_URL]) {
            ...
            */
            ...
            [self.tableView reloadData];
            [[Common instance] saveServicesPreload];
                
            if([[Common instance] getMarkWsServicesCount]) {
...
- (BOOL)addServices: (NSString*) url {
    ...
    XMLParser* parser = [[XMLParser alloc] initXMLParser:TYPE_SERVICE];
