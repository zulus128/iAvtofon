...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section
{
    ...
    return [[Common instance] getMarkWsSvcsCount];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Configure the cell...
    Mark* mark = [[Common instance]getMarkWsSvcAt:indexPath.row];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    Mark* mrk = [[Common instance]getMarkWsSvcAt:indexPath.row];
...
/*        Item* item = [[Common instance] getsAt:0];
  ...
  */      
        ...
        [[Common instance] clearMarkWsSvcs];
        if(![self addSvcs:XML_SVC_URL]) {
            ...
            */
            ...
            [self.tableView reloadData];
            [[Common instance] saveSvcsPreload];
                
            if([[Common instance] getMarkWsSvcsCount]) {
...
- (BOOL)addSvcs: (NSString*) url {
    ...
    XMLParser* parser = [[XMLParser alloc] initXMLParser:TYPE_SVC];
